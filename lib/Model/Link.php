 ...
 *
 * @category Class
 * @description A link to various ressources. a Link can have different meanings and targets. The type of relation is specified with the property &#x27;rel&#x27;.
 * @package  MehrIt\OttoShipmentsApiClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
...
'rel' => 'getRel'    ];
     ...
     * Sets rel
     *
     * @param string $rel The relation type of the link. See also https://www.iana.org/assignments/link-relations/link-relations.xhtml. The relation type 'next' is used for paging. The relation type 'self' refers to the url of the ressource
     *
     * @return $this
     */
