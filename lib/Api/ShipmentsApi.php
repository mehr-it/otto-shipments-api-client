...
namespace MehrIt\OttoShipmentsApiClient\Api;
...
use MehrIt\OttoShipmentsApiClient\ApiException;
use MehrIt\OttoShipmentsApiClient\Configuration;
use MehrIt\OttoShipmentsApiClient\HeaderSelector;
...
class ShipmentsApi
{
     ...
     *
     * @param  \MehrIt\OttoShipmentsApiClient\Model\PositionItem[] $body The position items included in shipment. (required)
     ...
     *
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\BadRequestAddPositionItemByTrackingNumber',
                ...
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\NotFoundAddPositionItemByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\ConflictAddPositionItemByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerErrorAddPositionItemByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \MehrIt\OttoShipmentsApiClient\Model\PositionItem[] $body positionItems (required)
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\BadRequestAddPositionItemByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\NotFoundAddPositionItemByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\ConflictAddPositionItemByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerErrorAddPositionItemByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \MehrIt\OttoShipmentsApiClient\Model\CreateShipmentRequest $body request (required)
     *
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoShipmentsApiClient\Model\CreateShipmentResponse
     */
     ...
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoShipmentsApiClient\Model\CreateShipmentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function createdAndSentShipmentUsingPOSTWithHttpInfo($body)
    {
        $returnType = '\MehrIt\OttoShipmentsApiClient\Model\CreateShipmentResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\CreateShipmentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\BadRequest',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 401:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\Unauthenticated',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\Conflict',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoShipmentsApiClient\Model\ShipmentList
     */
     ...
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoShipmentsApiClient\Model\ShipmentList, HTTP status code, HTTP response headers (array of strings)
     */
    public function listShipmentsUsingGETWithHttpInfo($datefrom, $limit = '25', $next = null)
    {
        $returnType = '\MehrIt\OttoShipmentsApiClient\Model\ShipmentList';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\ShipmentList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerErrorGetShipmentList',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    protected function listShipmentsUsingGETRequest($datefrom, $limit = '25', $next = null)
    {
        ...
        // query params
        if ($datefrom !== null) {
            $queryParams['datefrom'] = ObjectSerializer::toQueryValue($datefrom, 'YYYY-MM-DD');
        }
        // query params
        if ($limit !== null) {
     ...
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MehrIt\OttoShipmentsApiClient\Model\Shipment
     */
     ...
     * @throws \MehrIt\OttoShipmentsApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MehrIt\OttoShipmentsApiClient\Model\Shipment, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentByCarrierAndTrackingNumberUsingGETWithHttpInfo($carrier, $tracking_number)
    {
        $returnType = '\MehrIt\OttoShipmentsApiClient\Model\Shipment';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\Shipment',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\ForbiddenGetShipmentByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\NotFoundGetShipmentByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerErrorGetShipmentByTrackingNumber',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\ForbiddenGetShipmentByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 404:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\NotFoundGetShipmentByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MehrIt\OttoShipmentsApiClient\Model\InternalServerErrorGetShipmentByShipmentId',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
